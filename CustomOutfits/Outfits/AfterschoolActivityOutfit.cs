...
using Sims3.UI;
using AfterschoolActivity = Destrospean.CustomizableUncustomizableOutfits.Replacements.AfterschoolActivity;
using AfterschoolActivityCareer = Sims3.Gameplay.Careers.AfterschoolActivity;
...
{
    public class AfterschoolActivityOutfit
    {
        [Tunable]
        protected static bool kInstantiator;

        [PersistableStatic(true)]
        static List<ulong> sBalletOutfitDisabledList, sScoutsOutfitDisabledList;

        static EventListener sSimDescriptionDisposedListener, sSimSelectedListener;

        static AfterschoolActivityOutfit()
        {
        ...
        public class EditAfterschoolActivityOutfit : ImmediateInteraction<Sim, GameObject>
        {
            ...
            public class Definition : ImmediateInteractionDefinition<Sim, GameObject, EditAfterschoolActivityOutfit>
            {
                ...
                {
                    return (actor == target && Tuning.kShowSimMenu || target as Sim == null && Tuning.kShowObjectMenu) && actor.SimDescription.Child && actor.SimDescription.IsHuman && !actor.SimDescription.IsRobot && !isAutonomous && AfterschoolActivityCareer.HasAfterschoolActivityOfType(actor, mAfterschoolActivityType);
                }
            }
        ...
        public static void DisableAfterschoolActivityOutfit(SimDescription simDescription, AfterschoolActivityType afterschoolActivityType)
        {
        ...
        public static void DisableBalletOutfit(SimDescription simDescription)
        {
        ...
        public static void DisableScoutsOutfit(SimDescription simDescription)
        {
        ...
        public static void EnableAfterschoolActivityOutfit(SimDescription simDescription, AfterschoolActivityType afterschoolActivityType)
        {
            switch (afterschoolActivityType)
            {
                case AfterschoolActivityType.Ballet:
        ...
        public static void EnableBalletOutfit(SimDescription simDescription)
        {
            if (!GetAfterschoolActivityOutfitEnabled(simDescription, AfterschoolActivityType.Ballet))
            {
        ...
        public static void EnableScoutsOutfit(SimDescription simDescription)
        {
            if (!GetAfterschoolActivityOutfitEnabled(simDescription, AfterschoolActivityType.Scouts))
            {
        ...
        public static bool GetAfterschoolActivityOutfitEnabled(SimDescription simDescription, AfterschoolActivityType? afterschoolActivityType)
        {
        ...
        {
            SchoolRabbitHole.AttendAudition.Singleton = new AfterschoolActivity.AttendAudition.DefinitionModified();
            SchoolRabbitHole.AttendRecital.Singleton = new AfterschoolActivity.AttendRecital.DefinitionModified();
            Sim.DoShowOffMove.Singleton = new AfterschoolActivity.DoShowOffMove.DefinitionModified();
            Common.CopyTuning(typeof(SchoolRabbitHole), typeof(SchoolRabbitHole.AttendAudition.Definition), typeof(AfterschoolActivity.AttendAudition.DefinitionModified));
            Common.CopyTuning(typeof(SchoolRabbitHole), typeof(SchoolRabbitHole.AttendRecital.Definition), typeof(AfterschoolActivity.AttendRecital.DefinitionModified));
            Common.CopyTuning(typeof(Sim), typeof(Sim.DoShowOffMove.Definition), typeof(AfterschoolActivity.DoShowOffMove.DefinitionModified));
        }
...
{
    public class AfterschoolActivity
    {
        public class AttendAudition : SchoolRabbitHole.AttendAudition
        {
            ...
            public override bool BeforeRouting(Sim actor)
            {
                ...
                if (simDescription.Child)
                {
                    ...
                    if (AfterschoolActivityCareer.HasAfterschoolActivityOfType(actor, AfterschoolActivityType.Ballet))
                    {
                        afterschoolActivityType = AfterschoolActivityType.Ballet;
                        outfitName = AfterschoolActivityOutfit.GetAfterschoolActivityOutfitName(actor, AfterschoolActivityType.Ballet);
                    }
                    else if (AfterschoolActivityCareer.HasAfterschoolActivityOfType(actor, AfterschoolActivityType.Scouts))
                    {
                        afterschoolActivityType = AfterschoolActivityType.Scouts;
                        outfitName = AfterschoolActivityOutfit.GetAfterschoolActivityOutfitName(actor, AfterschoolActivityType.Scouts);
                    }
                    if (afterschoolActivityType != null && AfterschoolActivityOutfit.GetAfterschoolActivityOutfitEnabled(simDescription, afterschoolActivityType))
                    {
                ...
                if (IsMaster)
                {
                    ...
                    switch (skillForMoveType.Guid)
                    {
                        case SkillNames.Ballet:
                            ...
                            outfitName = AfterschoolActivityOutfit.GetAfterschoolActivityOutfitName(Actor, afterschoolActivityType);
                            break;
                    ...
                    if (simOutfit != null && AfterschoolActivityOutfit.GetAfterschoolActivityOutfitEnabled(simDescription, afterschoolActivityType))
                    {
