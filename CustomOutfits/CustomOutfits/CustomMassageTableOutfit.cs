    ...
    public class CustomMassageTableOutfit
    {
        ...
        public class ResetMassageTableOutfit : ImmediateInteraction<Sim, GameObject>
        {
            ...
            public class Definition : ImmediateInteractionDefinition<Sim, GameObject, ResetMassageTableOutfit>
            {
                ...
                public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                {
                    return (actor == target && Tuning.kShowSimMenu || target as Sim == null && Tuning.kShowObjectMenu) && actor.SimDescription.TeenOrAbove && actor.SimDescription.IsHuman && !actor.SimDescription.IsRobot && !isAutonomous && actor.SimDescription.HasSpecialOutfit(kMassageTableSpecialOutfitKey);
                }
            }
        ...
        {
            Array.ForEach(Sims3.Gameplay.Queries.GetObjects<MassageTable>(), AddInteractions);
