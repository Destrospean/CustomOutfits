...
namespace Destrospean
{
    public class CustomMechanicalBullOutfit
    {
        ...
        static void OnObjectPlacedInLot(object sender, EventArgs e)
        {
            ...
            {
                AddInteractions(GameObject.GetObject(onObjectPlacedInLotEventArgs.ObjectId) as MechanicalBull);
            }
        }
        ...
        {
            Array.ForEach(Sims3.Gameplay.Queries.GetObjects<MechanicalBull>(), AddInteractions);
