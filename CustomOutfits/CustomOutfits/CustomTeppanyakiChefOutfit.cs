    ...
    public class CustomTeppanyakiChefOutfit
    {
        ...
        public class ResetChefOutfit : ImmediateInteraction<Sim, GameObject>
        {
            ...
            public class Definition : ImmediateInteractionDefinition<Sim, GameObject, ResetChefOutfit>
            {
                ...
                public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                {
                    return (actor == target && Tuning.kShowSimMenu || target as Sim == null && Tuning.kShowObjectMenu) && actor.SimDescription.TeenOrAbove && actor.SimDescription.IsHuman && !actor.SimDescription.IsRobot && !isAutonomous && actor.SimDescription.HasSpecialOutfit(kChefSpecialOutfitKey);
                }
            }
        ...
        {
            Array.ForEach(Sims3.Gameplay.Queries.GetObjects<TeppanyakiGrill>(), AddInteractions);
